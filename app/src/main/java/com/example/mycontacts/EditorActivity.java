...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private String mType = Contract.ContactEntry.TYPEOFCONTACT_MANAGER;
    ImageView mPhoto;
        ...
        mSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.manager))) {
                        mType = Contract.ContactEntry.TYPEOFCONTACT_MANAGER;
                    } else if (selection.equals(getString(R.string.employee))) {
                        mType = Contract.ContactEntry.TYPEOFCONTACT_EMPLOYEE;

                    } else if (selection.equals(getString(R.string.security))) {
                        mType = Contract.ContactEntry.TYPEOFCONTACT_SECURITY;

                    }
                    else if (selection.equals(getString(R.string.Contractor))) {
                        mType = Contract.ContactEntry.TYPEOFCONTACT_CONTRACTOR;

                    } else if (selection.equals(getString(R.string.other))) {
                        mType = Contract.ContactEntry.TYPEOFCONTACT_OTHER;
    ...
    private boolean saveContact() {
        ...
        && TextUtils.isEmpty(email) && TextUtils.isEmpty(phone) && mType == Contract.ContactEntry.TYPEOFCONTACT_OTHER && mPhotoUri == null) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (typeof) {
                ...
                case Contract.ContactEntry.TYPEOFCONTACT_MANAGER:
                    mSpinner.setSelection(1);
                    break;

                case Contract.ContactEntry.TYPEOFCONTACT_EMPLOYEE:
                        mSpinner.setSelection(2);
                    break;

                case Contract.ContactEntry.TYPEOFCONTACT_SECURITY:
                    mSpinner.setSelection(3);
                    break;

                case Contract.ContactEntry.TYPEOFCONTACT_CONTRACTOR:
                    mSpinner.setSelection(4);
                    break;
                case Contract.ContactEntry.TYPEOFCONTACT_OTHER:
